        ...
        <div className="mt-10 space-y-8 text-sm leading-7 text-slate-300">
          <section>
            ...
            <p className="mt-2">
              ...
              you and {COMPANY_NAME} ("we", "us", "our"). By accessing or using
              Shadow Journal and related services (the "Services"), you agree to
              these Terms.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-2 pl-5">
              ...
              <li>
                We may suspend or terminate accounts used for abuse, fraud, or
          ...
          <section>
            ...
            <p className="mt-2">
              You may not copy, reverse engineer, resell, or misuse the Services
          ...
          <section>
            <h2 className="text-xl font-semibold text-white">
              4. Paid Plans, Billing, and Credits
            </h2>
            <ul className="mt-2 list-disc space-y-2 pl-5">
              <li>
                Certain features require a paid subscription or one-time
                purchases. Billing is processed by Stripe.
              </li>
              <li>
                Subscription and top-up credits are consumed when you use
                eligible AI features.
              </li>
              <li>
                You can manage or cancel subscriptions via the billing portal
                where available.
              </li>
              <li>
          ...
          <section>
            ...
            <p className="mt-2">
              AI output is generated automatically and may be incomplete or
              inaccurate. It is provided for reflection and informational
              purposes only, not medical, psychiatric, therapeutic, legal, or
              financial advice.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc space-y-2 pl-5">
              <li>
                Do not use the Services for unlawful, harmful, or fraudulent
                activity.
              </li>
              <li>
                Do not attempt to bypass security, abuse APIs, or disrupt
                operations.
              </li>
          ...
          <section>
            ...
            <p className="mt-2">
              The Services rely on third-party providers (for example, hosting,
              payments, and model providers). We are not responsible for
              third-party service outages or policies.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              terminate access if you materially violate these Terms or where
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              maximum extent permitted by law, without warranties of
              uninterrupted availability, merchantability, fitness for a
