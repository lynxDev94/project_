...
export function PwaInstallDialog({
  ...
  return (
    ...
    >
      <DialogContent className="bg-background-dark border-white/10 text-slate-100 sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-white">
            Install Shadow Journal
          </DialogTitle>
        ...
        {isIos ? (
          <ol className="list-decimal space-y-2 pl-4 text-sm text-slate-300">
            <li>
              Tap the Share button (square with arrow) at the bottom or top of
              Safari.
            </li>
            <li>
              Scroll and tap{" "}
          ...
          <div className="space-y-3 text-sm text-slate-300">
            <p>
              ...
              <span className="font-medium text-white">Edge</span>, open the
              menu (three dots, top-right). Choose{" "}
            ...
            <p className="text-slate-400">
              If you do not see that yet, refresh this page or open another page
              (for example Sign in) and come back—then try again.
            </p>
          </div>
        )}
      </DialogContent>
