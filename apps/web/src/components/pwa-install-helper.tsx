    ...
    <div className="fixed right-4 bottom-4 z-[9999] w-[min(22rem,calc(100vw-2rem))] rounded-2xl border border-slate-200 bg-white/95 p-4 shadow-xl backdrop-blur">
      ...
      {canNativeInstall ? (
        ...
        <p className="mt-1 text-xs text-slate-600">
          ...
          <span className="font-medium">Install the app</span> in the menu
          above.
        </p>
      ) : (
        <p className="mt-1 text-xs text-slate-600">
          Use <span className="font-medium">Install the app</span> in the header
          for steps. In Chrome or Edge you can also use the menu (three dots) →
          Install, once your browser shows it.
        </p>
      )}
